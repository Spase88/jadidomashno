const btnSpin = () => {
    ...
    btnSpin.classList.add("loading");
    btnSpin.innerHTML = `<span class='icon'><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin:   auto; background: none; display: inline-block; shape-rendering: auto;" width="25px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
