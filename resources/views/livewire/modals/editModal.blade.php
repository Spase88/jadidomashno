    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">@yield("editModalHeader")</h3>
                <form class="space-y-6" wire:submit.prevent = "@yield('editMethod')">
                    @yield("editModalContent")
                    <button type="submit" class="w-full text-white bg-main-orange font-medium rounded-lg text-sm px-5 py-2.5 text-center mt-3">Зачувај ги промените</button>
                </form>
            </div>
        </div>
    </div>
