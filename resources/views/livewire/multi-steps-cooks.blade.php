<div>
        ...
        <div class = "flex mb-5">
            ...
            <a href="{{ route('register-cooks') }}" class = "w-full">
                <button type="button" class="text-white w-full font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center bg-main-orange mr-2 mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#FFFBF5" height="24px" width="24px" version="1.1" id="Capa_1" viewBox="0 0 219.792 219.792" xml:space="preserve" class = "mr-2">
                        <g>
    ...
    @include('livewire.registerCooks')
